        ...
        <div class="relative bg-white dark:bg-[#1a1f3d] rounded-xl w-full max-w-lg border border-gray-200 dark:border-white/10 shadow-2xl" @click.stop>
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input x-model="form.name" class="w-full px-3 py-2 bg-white dark:bg-[#0f1535] border border-gray-300 dark:border-white/10 rounded-lg text-sm" placeholder="e.g., Supervisor">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1">Access Level (0-99)</label>
                    <input x-model="form.access_level" type="number" min="0" max="99" class="w-full px-3 py-2 bg-white dark:bg-[#0f1535] border border-gray-300 dark:border-white/10 rounded-lg text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1">Description</label>
                    <input x-model="form.description" class="w-full px-3 py-2 bg-white dark:bg-[#0f1535] border border-gray-300 dark:border-white/10 rounded-lg text-sm">
                </div>
                <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\POS Software\D Star Company\resources\views/roles/index.blade.php ENDPATH**/ ?>