...
<head>
    ...
    <title>Sign In — <?php echo e($companyName ?: config('app.name', 'Aronium Lite')); ?></title>
...
<div class="w-full max-w-sm" x-data="loginForm">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
        ...
        <div class="flex flex-col items-center mb-8">
            <?php if($companyLogo): ?>
                <img src="<?php echo e($companyLogo); ?>" class="h-16 max-w-[200px] object-contain mb-4" alt="Logo">
            <?php else: ?>
                <div class="w-14 h-14 rounded-full bg-blue-600 flex items-center justify-center mb-4 ring-2 ring-white/20 dark:ring-white/10">
                    <span class="text-white text-xl font-bold"><?php echo e(Str::substr($companyName ?: config('app.name', 'AL'), 0, 1)); ?></span>
                    <span class="text-white text-xl font-bold"><?php echo e(Str::substr($companyName ?: config('app.name', 'AL'), 0, 1)); ?></span>
                </div>
            <?php endif; ?>
            <h1 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($companyName ?: config('app.name', 'Aronium Lite')); ?></h1>
    ...
    <p class="mt-8 text-center text-xs text-gray-400 dark:text-gray-600">
        &copy; <?php echo e(date('Y')); ?> <?php echo e($companyName ?: config('app.name', 'Aronium Lite')); ?>. All rights reserved.
    </p>
</div>
...
<?php /**PATH E:\POS Software\D Star Company\resources\views/auth/login.blade.php ENDPATH**/ ?>