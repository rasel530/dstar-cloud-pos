            ...
            <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                <thead class="bg-slate-50 dark:bg-slate-800/50">
                    <tr>
                        ...
                        <th class="px-6 py-3.5 text-right text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Rate</th>
                    ...
                    <template x-if="!loading && taxes.length === 0">
                        <tr>
                            <td colspan="5" class="px-6 py-16 text-center">
                                ...
                                <h3 class="mt-3 text-sm font-medium text-slate-900 dark:text-white">No taxes found</h3>
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Get started by adding your first tax rate.</p>
                            </td>
                        </tr>
                    </template>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="text-sm font-medium text-slate-900 dark:text-white" x-text="t.name"></div>
                                        <div class="text-xs text-slate-500 dark:text-slate-400" x-text="t.code || ''"></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <span
                                    ...
                                    :class="t.is_fixed ? 'text-blue-600 dark:text-blue-400' : 'text-slate-700 dark:text-slate-300'"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <button
                                    ...
                                    :class="t.is_enabled ? 'bg-blue-600 dark:bg-blue-500' : 'bg-slate-300 dark:bg-slate-600'"
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            ...
            >
                <div class="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-slate-700">
                    <h3 id="modal-title" class="text-lg font-semibold text-slate-900 dark:text-white" x-text="editing ? 'Edit Tax' : 'Add Tax'"></h3>
                    <button
                        @click="showModal = false"
                ...
                <form @submit.prevent="save()" class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                class="w-full px-3 py-2 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors"
                            />
                            <span class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm text-slate-500 dark:text-slate-400" x-text="form.is_fixed ? '$' : '%'"></span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 py-1">
                        <button
                            ...
                            class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-800"
                            :class="form.is_fixed ? 'bg-blue-600 dark:bg-blue-500' : 'bg-slate-300 dark:bg-slate-600'"
                        ...
                        <span class="text-sm text-slate-700 dark:text-slate-300" x-text="form.is_fixed ? 'Fixed Amount' : 'Percentage'"></span>
                    </div>
