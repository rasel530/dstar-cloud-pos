        ...
        <nav class="flex-1 py-4 space-y-1 px-2 overflow-y-auto scrollbar-thin">
            @php
                $sidebarIcons = [
                    ...
                    'purchases' => '<path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12"/>',
                    'income-expenses' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/>',
                    'barcodes' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 4.875c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 1.125 0 013.75 9.375v-4.5zm0 9.75c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5a1.125 1.125 0 01-1.125-1.125v-4.5zm9.75-9.75c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 1.125 0 0113.5 9.375v-4.5zm0 9.75c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5a1.125 1.125 0 01-1.125-1.125v-4.5z"/>',
                ...
                $moduleRoutes = [
                    ...
                    'purchases'  => 'web.purchases.index',
                    'income-expenses' => 'web.income-expenses.index',
                    'barcodes'   => 'web.barcodes.index',
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <header class="flex items-center justify-between h-16 px-4 lg:px-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shrink-0">
            ...
            <div class="flex items-center gap-2 sm:gap-4 flex-wrap">
                ...
                <div class="flex items-center gap-2 min-w-0" x-cloak x-show="user">
                    <div class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white text-sm font-medium flex-shrink-0" x-text="((user?.first_name || user?.username || 'U').charAt(0)?.toUpperCase() || 'U')"></div>
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300 truncate max-w-[100px] sm:max-w-[140px] md:max-w-[180px] lg:max-w-[220px]" x-text="((user?.first_name || '') + ' ' + (user?.last_name || '')).trim() || user?.username || 'User'"></span>
                </div>
            </div>
        </header>
