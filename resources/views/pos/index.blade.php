...
<div x-data="posCart" x-init="init()" class="flex h-full overflow-hidden bg-gray-50 dark:bg-[#0f1535]">
    ...
    {{-- Processing Overlay --}}
    <div x-show="processingPayment && !showPayment && !showReceipt" x-cloak class="fixed inset-0 z-[80] flex flex-col items-center justify-center bg-black/60">
        ...
        <p class="text-white/60 text-xs mt-1">Please wait</p>
    </div>
