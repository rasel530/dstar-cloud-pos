...
@section('content')
<div x-data="inventoryManager" class="min-h-full">
    ...
    <div class="px-6 space-y-6">
                 ...
                 <div class="bg-white dark:bg-[#1a1f3d] rounded-xl border border-gray-100 dark:border-white/5 p-5 hover:shadow-md transition-shadow"
                     ...
                     <div class="flex items-center justify-between mb-3">
                         ...
                         <div class="flex items-center gap-1">
                             ...
                             <button @click.stop="openEditWarehouse(w)" class="p-1 rounded text-gray-400 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors" title="Edit">
                             ...
                             <button @click.stop="deleteWarehouse(w.id)" class="p-1 rounded text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors" title="Delete">
        ...
        <div x-show="selectedWarehouse" class="bg-white dark:bg-[#1a1f3d] rounded-xl border border-gray-100 dark:border-white/5">
            ...
            <div x-show="stockLoading" class="flex justify-center py-12">
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b border-gray-100 dark:border-white/5">
                                <th class="text-left text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3">Product</th>
                                <th class="text-left text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3">Code</th>
                                <th class="text-right text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3">Quantity</th>
                                 <th class="text-right text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3" x-show="$store.sys.isMulti()">Branch Stock</th>
                                <th class="text-right text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3">Adjust</th>
                            </tr>
                        </thead>
                        <tbody>
                            <template x-for="s in warehouseStocks" :key="s.product_id">
                                <tr class="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5">
                                    <td class="px-6 py-3 font-medium text-gray-900 dark:text-white" x-text="s.product_name"></td>
                                    <td class="px-6 py-3 font-mono text-xs text-gray-500 dark:text-white/50" x-text="s.product_code || '--'"></td>
            ...
            <div x-show="!stockLoading && !warehouseStocks.length" class="p-6 text-center">
