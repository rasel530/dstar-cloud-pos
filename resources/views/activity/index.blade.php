...
@section('content')
<div x-data="activityManager" class="min-h-full">
    ...
    <div class="px-6">
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl border border-gray-100 dark:border-white/5 p-4 mb-4 grid grid-cols-1 sm:grid-cols-4 gap-3">
        ...
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl border border-gray-100 dark:border-white/5 overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-white/5">
                            <th class="text-left text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3">Event Category</th>
                            <th class="text-left text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3">Event Description</th>
                            <th class="text-left text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3">Performed By</th>
                            <th class="text-left text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3">Event Time</th>
                            <th class="text-left text-xs font-medium text-gray-500 dark:text-white/50 uppercase px-6 py-3">Client IP</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div x-show="pagination" class="flex items-center justify-between px-6 py-3 border-t border-gray-100 dark:border-white/5">
