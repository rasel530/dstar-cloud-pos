...
@section('content')
<div x-data="productsManager" class="min-h-full">
    <div class="flex items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <button @click="showTransferModal = true" x-show="$store.sys.isMulti()" class="bg-purple-500 hover:bg-purple-600 text-white text-sm font-medium px-4 py-2 rounded-lg transition flex items-center gap-2">
    ...
    <div class="px-6">
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl border border-gray-100 dark:border-white/5 mb-6">
            ...
            <div x-show="!loading && products.length === 0" class="text-center py-12 text-gray-400 dark:text-white/30">
            ...
            <div x-show="pagination && pagination.total > 0" class="flex items-center justify-between px-6 py-3 border-t border-gray-100 dark:border-white/5">
            ...
            <form @submit.prevent="save()" class="p-6 space-y-4">
                ...
                <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Product Group</label>
                    <div class="flex gap-2">
                        ...
                        <button type="button" @click="showNewGroup = !showNewGroup" class="px-3 py-2 bg-gray-100 dark:bg-gray-700 text-sm rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"><span x-text="showNewGroup ? '\u2715' : '+ New'"></span></button>
                    </div>
                ...
                <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Measurement Unit</label>
                    <div class="flex gap-2">
                        ...
                        <button type="button" @click="showNewUnit = !showNewUnit" class="px-3 py-2 bg-gray-100 dark:bg-gray-700 text-sm rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"><span x-text="showNewUnit ? '\u2715' : '+ New'"></span></button>
                    </div>
