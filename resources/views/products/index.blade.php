                                ...
                                <tr class="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition">
                                    ...
                                    <td class="px-6 py-3 text-right whitespace-nowrap">
                                        <div class="flex items-center justify-end gap-1.5">
                                            <button @click="openEdit(p)" class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-white/10 dark:text-gray-200 dark:hover:bg-white/15 border border-transparent transition whitespace-nowrap" title="Edit">
                                            ...
                                            <button @click="deleteProduct(p.id)" class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-rose-50 text-rose-600 hover:bg-rose-100 dark:bg-rose-500/10 dark:text-rose-400 dark:hover:bg-rose-500/20 border border-transparent transition whitespace-nowrap" title="Delete">
            ...
            <form @submit.prevent="save()" class="p-6 space-y-4">
                ...
                <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Product Group</label>
                    <div class="flex gap-2">
                        ...
                        <button type="button" @click="showNewGroup = !showNewGroup; showManage = false" class="px-2 sm:px-3 py-2 bg-gray-100 dark:bg-gray-700 text-sm rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors shrink-0"><span x-text="showNewGroup ? '\u2715' : '+ New'"></span></button>
                ...
                <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Measurement Unit</label>
                    <div class="flex gap-2">
                        ...
                        <button type="button" @click="showNewUnit = !showNewUnit; showManageUnit = false" class="px-2 sm:px-3 py-2 bg-gray-100 dark:bg-gray-700 text-sm rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors shrink-0"><span x-text="showNewUnit ? '\u2715' : '+ New'"></span></button>
