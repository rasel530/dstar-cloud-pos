...
<div x-data="fiscalItemsManager" class="flex flex-col h-full">
    ...
    <div class="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 shrink-0">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage PLU-to-VAT mappings</p>
        </div>
        <button
            @click="openAdd()"
    ...
    <div class="relative">
        ...
        <input
            ...
            class="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-[#1a1f3d] border border-gray-300 dark:border-white/10 rounded-lg text-sm text-gray-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors"
        />
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-200 dark:divide-white/5">
                <thead class="bg-gray-50 dark:bg-white/5">
                    <tr>
                        <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">PLU</th>
                        <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Name</th>
                        <th class="px-6 py-3.5 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">VAT (%)</th>
                    ...
                    <template x-if="!loading && items.length === 0">
                        <tr>
                            <td colspan="4" class="px-6 py-16 text-center">
                                ...
                                <h3 class="mt-3 text-sm font-medium text-gray-900 dark:text-white">No fiscal items found</h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by adding your first fiscal item.</p>
                            </td>
                        </tr>
                    </template>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5/50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="text-sm font-medium text-gray-900 dark:text-white font-mono" x-text="item.plu"></div>
                                    </div>
                                </div>
                            </td>
    ...
    >
        ...
        <div class="flex flex flex-col h-full items-center justify-center p-4">
            <div
                ...
                x-transition
                @click.stop
                class="relative w-full max-w-md bg-white dark:bg-[#1a1f3d] rounded-xl shadow-2xl border border-gray-200 dark:border-white/10"
            >
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-white/10">
                    <h3 id="modal-title" class="text-lg font-semibold text-gray-900 dark:text-white" x-text="editing ? 'Edit Fiscal Item' : 'Add Fiscal Item'"></h3>
                    <button
                        @click="showModal = false"
