...
@section('content')
<div x-data="settingsManager" class="px-4 sm:px-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-2 py-4">
        ...
        <span x-show="saveStatus === 'saved'" class="w-full sm:w-auto text-sm text-green-600 dark:text-green-400 font-medium animate-pulse">Settings saved successfully</span>
        <span x-show="saveStatus === 'error'" class="w-full sm:w-auto text-sm text-red-600 dark:text-red-400 font-medium">Failed to save. Please try again.</span>
    </div>

    <div class="flex gap-1 overflow-x-auto pb-2 shrink-0">
        <button @click="activeTab = 'general'" :class="activeTab === 'general' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-[#1a1f3d] text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/5'" class="shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition whitespace-nowrap flex items-center gap-1.5">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"/></svg>
            General
        </button>
        <button @click="activeTab = 'pos'" :class="activeTab === 'pos' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-[#1a1f3d] text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/5'" class="shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition whitespace-nowrap flex items-center gap-1.5">
        ...
        <button @click="activeTab = 'receipt'" :class="activeTab === 'receipt' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-[#1a1f3d] text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/5'" class="shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition whitespace-nowrap flex items-center gap-1.5">
        ...
        <button @click="activeTab = 'notifications'" :class="activeTab === 'notifications' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-[#1a1f3d] text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/5'" class="shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition whitespace-nowrap flex items-center gap-1.5">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0"/></svg>
            Notifications
        </button>
        <button @click="activeTab = 'system'" :class="activeTab === 'system' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-[#1a1f3d] text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/5'" class="shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition whitespace-nowrap flex items-center gap-1.5">
        ...
        <button @click="activeTab = 'payment-methods'" :class="activeTab === 'payment-methods' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-[#1a1f3d] text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/5'" class="shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition whitespace-nowrap flex items-center gap-1.5">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z"/></svg>
            Payment Methods
        </button>
        <button @click="activeTab = 'barcode'" :class="activeTab === 'barcode' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-[#1a1f3d] text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/5'" class="shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition whitespace-nowrap flex items-center gap-1.5">
        ...
        <button @click="activeTab = 'cash-register'" :class="activeTab === 'cash-register' ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-[#1a1f3d] text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/5'" class="shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition whitespace-nowrap flex items-center gap-1.5">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z"/></svg>
            Cash Register
        </button>
    </div>
    ...
    <div x-show="activeTab === 'general'" x-cloak class="space-y-5">
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 p-6">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-4">Company Information</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Company Name</label>
                    <input type="text" x-model="form.company_name" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Address</label>
                    <input type="text" x-model="form.company_address" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Phone</label>
                    <input type="text" x-model="form.company_phone" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Email</label>
                    <input type="email" x-model="form.company_email" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                </div>
            </div>
        </div>

        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 p-6">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-4">Regional Settings</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
    ...
    <div x-show="activeTab === 'pos'" x-cloak class="space-y-5">
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 p-6">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-4">Product Grid Layout</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Grid Columns</label>
                    <select x-model="form.grid_columns" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Grid Rows</label>
                    <select x-model="form.grid_rows" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
        ...
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 p-6">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-4">Interface</h2>
            <div class="space-y-4">
                <div class="flex flex-col gap-2">
                    <div>
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Sound Effects</span>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Play sounds on sale completion, alerts, and errors</p>
                    </div>
                    <button
                        type="button"
                        @click="form.sound_effects = !form.sound_effects"
                        class="relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                        :class="form.sound_effects ? 'bg-blue-600 dark:bg-blue-500' : 'bg-gray-300 dark:bg-white/10'"
                ...
                <div class="flex flex-col gap-2">
                    <div>
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Payment Confirmation</span>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Require confirmation dialog before finalizing payment</p>
                    </div>
                    <button
                        type="button"
                        @click="form.payment_confirmation = !form.payment_confirmation"
                        class="relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                        :class="form.payment_confirmation ? 'bg-blue-600 dark:bg-blue-500' : 'bg-gray-300 dark:bg-white/10'"
                ...
                <div class="flex flex-col gap-2">
                    <div>
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Dine-in Order Type</span>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Enable dine-in option on the POS interface</p>
                    </div>
                    <button type="button" @click="form.dine_in_enabled = !form.dine_in_enabled" class="relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800" :class="form.dine_in_enabled ? 'bg-blue-600 dark:bg-blue-500' : 'bg-gray-300 dark:bg-white/10'" :aria-checked="form.dine_in_enabled" role="switch">
                        <span class="inline-block h-4 w-4 rounded-full bg-white shadow-sm transform transition-transform duration-200" :class="form.dine_in_enabled ? 'translate-x-6' : 'translate-x-1'"></span>
                    </button>
                </div>
                <div class="flex flex-col gap-2">
                    <div>
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Takeaway Order Type</span>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Enable takeaway option on the POS interface</p>
                    </div>
                    <button type="button" @click="form.takeaway_enabled = !form.takeaway_enabled" class="relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800" :class="form.takeaway_enabled ? 'bg-blue-600 dark:bg-blue-500' : 'bg-gray-300 dark:bg-white/10'" :aria-checked="form.takeaway_enabled" role="switch">
                        <span class="inline-block h-4 w-4 rounded-full bg-white shadow-sm transform transition-transform duration-200" :class="form.takeaway_enabled ? 'translate-x-6' : 'translate-x-1'"></span>
                    </button>
                </div>
                <div class="flex flex-col gap-2">
                    <div>
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Table Management</span>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Show table number input on POS</p>
                    </div>
                    <button type="button" @click="form.table_management_enabled = !form.table_management_enabled" class="relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800" :class="form.table_management_enabled ? 'bg-blue-600 dark:bg-blue-500' : 'bg-gray-300 dark:bg-white/10'" :aria-checked="form.table_management_enabled" role="switch">
                        <span class="inline-block h-4 w-4 rounded-full bg-white shadow-sm transform transition-transform duration-200" :class="form.table_management_enabled ? 'translate-x-6' : 'translate-x-1'"></span>
                    </button>
                </div></div>
            </div>
        </div>
    ...
    <div x-show="activeTab === 'receipt'" x-cloak class="space-y-5">
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 p-6">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-4">Receipt Content</h2>
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Header Text</label>
                    <textarea x-model="form.receipt_header" rows="2" placeholder="Thank you for your purchase!" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors resize-none"></textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Footer Text</label>
                    <textarea x-model="form.receipt_footer" rows="2" placeholder="Please come again! | No returns after 7 days." class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors resize-none"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="max-w-xs">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Number of Copies</label>
                    <select x-model.number="form.receipt_copies" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                ...
                <div class="max-w-xs">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Paper Width</label>
                    <select x-model.number="form.paper_width" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                        <option value="80">80 mm (Standard)</option>
                        <option value="58">58 mm (Compact)</option>
                    </select>
                </div>
                <div class="max-w-xs">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Auto-Print Receipt</label>
                    <select x-model="form.receipt_auto_print" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                ...
                <div class="max-w-xs">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" :checked="form.receipt_qr_enabled === 'true'" @change="form.receipt_qr_enabled = $event.target.checked ? 'true' : 'false'" class="w-4 h-4 rounded border-gray-300 dark:border-white/10 text-blue-600 focus:ring-blue-500">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Enable QR Code on Receipt</span>
                    </label>
                </div>
                <div class="max-w-xs" x-show="form.receipt_qr_enabled === 'true'">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">QR Base URL</label>
                    <input type="text" x-model="form.receipt_qr_base_url" placeholder="https://yourcompany.com" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                </div>
            </div>
        </div>
    </div>
    ...
    <div x-show="activeTab === 'notifications'" x-cloak class="space-y-5">
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 p-6">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-4">Notification Display</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Duration (seconds)</label>
                    <input type="number" x-model.number="form.notification_duration" min="1" max="30" step="1" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">How long toast notifications stay visible</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Position</label>
                    <select x-model="form.notification_position" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-[#0f1535] text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-colors">
    ...
    <div x-show="activeTab === 'system'" x-cloak class="space-y-5">
        <div class="bg-white dark:bg-[#1a1f3d] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 p-6">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-4">System Mode</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Choose how the system manages branches. Switching modes takes effect immediately and does not affect existing data.</p>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="relative rounded-xl border-2 p-5 cursor-pointer transition-all"
                    :class="form.system_mode === 'multi_branch' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-white/10 hover:border-gray-300 dark:hover:border-slate-500'"
                    ...
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            <span class="text-sm font-semibold text-gray-900 dark:text-white">Multi-Branch Mode</span>
                            <span x-show="form.system_mode === 'multi_branch'" class="ml-2 text-xs text-blue-600 dark:text-blue-400 font-medium">Active</span>
                        </div>
                    </div>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Full branch management with independent inventories, stock transfers, and branch-scoped operations.</p>
                </div>
                <div class="relative rounded-xl border-2 p-5 cursor-pointer transition-all"
                    :class="form.system_mode === 'single' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-white/10 hover:border-gray-300 dark:hover:border-slate-500'"
                    ...
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            <span class="text-sm font-semibold text-gray-900 dark:text-white">Single-Company Mode</span>
                            <span x-show="form.system_mode === 'single'" class="ml-2 text-xs text-emerald-600 dark:text-emerald-400 font-medium">Active</span>
                        </div>
                    </div>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Simplified operation without branch management. All inventory and transactions use a single company context.</p>
                </div>
            </div>
        ...
        <div x-show="activeTab === 'cash-register'" x-cloak class="space-y-5">
            <div class="bg-white dark:bg-[#1a1f3d] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:flex-wrap gap-2 mb-4">
                    <input type="text" x-model="shiftForm.name" placeholder="Shift name (e.g. Morning)" class="w-full sm:flex-1 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                    <input type="time" x-model="shiftForm.start_time" class="w-full sm:w-auto px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                    <input type="time" x-model="shiftForm.end_time" class="w-full sm:w-auto px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                    <button @click="addShift()" class="w-full sm:w-auto px-3 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700">Add</button>
                </div>
            </div>
